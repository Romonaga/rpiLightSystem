...
namespace TooJpeg
{
  ...
  typedef void (*WRITE_ONE_BYTE)(void* caller, unsigned char);
  ...
  bool writeJpeg(void* caller, WRITE_ONE_BYTE output, const void* pixels, unsigned short width, unsigned short height,
...
//Modifed TheFantastic work done here to make it more c++ like.  I needed the callback to have a refernce to the calling class.
//As such you will see I modifed all the calls in his library to take a void* so I could get a caller back.
//outside this change his work remains untouched.
